...
function Nav() {
  ...
  return (
    <div className= 'text-white absolute top-20 p-4'>
      ...
      {open && 
      <nav id="banner-link-spacer" className= 'text-white text-center relative w-72 bg-zinc-800 flex flex-col flex-nowrap text-3xl text-nowrap -translate-x-4 rounded-lg z-50'>

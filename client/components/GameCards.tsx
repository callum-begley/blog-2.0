function GameCards(){
   ...
   return (
    ...
    <div className="bg-zinc-700 bg-opacity-40 backdrop-blur-sm grid min-h-[40rem] rounded-2xl place-content-center text-center p-4 ring-2 dark:ring-white ring-zinc-800 my-10 hover:bg-opacity-60 hover:shadow-[0px_3px_30px_rgba(137,243,54,0.7)]">
    ...
    <div className="bg-zinc-700 bg-opacity-40 backdrop-blur-sm grid min-h-[40rem] rounded-2xl place-content-center text-center p-4 ring-2 dark:ring-white ring-zinc-800 my-10 hover:bg-opacity-60 hover:shadow-[0px_3px_30px_rgba(137,243,54,0.7)]">
      <h2 className="text-4xl pb-2">Conway&#39;s Game Of Life</h2>
